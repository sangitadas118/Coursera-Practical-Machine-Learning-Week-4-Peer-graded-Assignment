...
```{r}
dfTrain <- read.csv("pml-training.csv", stringsAsFactors = F,na.strings = c("","NA"))
dfTest <- read.csv("pml-testing.csv", stringsAsFactors = F,na.strings = c("","NA"))
...
result <- data.frame("problem_id" = dfTest$problem_id,
                     "PREDICTION" = predict(modelRF,xTest))
